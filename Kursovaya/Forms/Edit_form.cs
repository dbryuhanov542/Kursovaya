...
namespace Kursovaya
{
    public partial class Edit_form : Form
    {
        ...
        {
            DataTable data = DataConnection.vhod("select * from requests");
        ...
        {
            DataTable data = DataConnection.vhod(@" DELETE FROM KursovayaDB.requests WHERE id =" + 
            dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex].Cells[0].Value.ToString());
            DataTable data1 = DataConnection.vhod("select * from requests");
